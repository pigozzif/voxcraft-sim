...
__global__ void gpu_update_temperature(VX3_Voxel *voxels, int num, double TempAmplitude, double TempPeriod, double currentTime, VX3_VoxelyzeKernel* k, VX3_DistributedNeuralController* controller) {
    ...
    if (gindex < num) {
        ...
        printf("temp for (%d,%d,%d) at %f neighbors {pos_x:(%d,%d,%d) neg_x:(%d,%d,%d) pos_y:(%d,%d,%d) neg_y:(%d,%d,%d) pos_z:(%d,%d,%d) neg_z:(%d,%d,%d)}: %f\n", t->ix, t->iy, t->iz, currentTime, currentTemperature, (t->adjacentVoxel((linkDirection)0)) ? t->adjacentVoxel((linkDirection)0)->ix : -1, (t->adjacentVoxel((linkDirection)0)) ? t->adjacentVoxel((linkDirection)0)->iy : -1, (t->adjacentVoxel((linkDirection)0)) ? t->adjacentVoxel((linkDirection)0)->iz : -1, (t->adjacentVoxel((linkDirection)1)) ? t->adjacentVoxel((linkDirection)1)->ix : -1, (t->adjacentVoxel((linkDirection)1)) ? t->adjacentVoxel((linkDirection)1)->iy : -1, (t->adjacentVoxel((linkDirection)1)) ? t->adjacentVoxel((linkDirection)1)->iz : -1, (t->adjacentVoxel((linkDirection)2)) ? t->adjacentVoxel((linkDirection)2)->ix : -1, (t->adjacentVoxel((linkDirection)2)) ? t->adjacentVoxel((linkDirection)2)->iy : -1, (t->adjacentVoxel((linkDirection)2)) ? t->adjacentVoxel((linkDirection)2)->iz : -1, (t->adjacentVoxel((linkDirection)3)) ? t->adjacentVoxel((linkDirection)3)->ix : -1, (t->adjacentVoxel((linkDirection)3)) ? t->adjacentVoxel((linkDirection)3)->iy : -1, (t->adjacentVoxel((linkDirection)3)) ? t->adjacentVoxel((linkDirection)3)->iz : -1, (t->adjacentVoxel((linkDirection)4)) ? t->adjacentVoxel((linkDirection)4)->ix : -1, (t->adjacentVoxel((linkDirection)4)) ? t->adjacentVoxel((linkDirection)4)->iy : -1, (t->adjacentVoxel((linkDirection)4)) ? t->adjacentVoxel((linkDirection)4)->iz : -1, (t->adjacentVoxel((linkDirection)5)) ? t->adjacentVoxel((linkDirection)5)->ix : -1, (t->adjacentVoxel((linkDirection)5)) ? t->adjacentVoxel((linkDirection)5)->iy : -1, (t->adjacentVoxel((linkDirection)5)) ? t->adjacentVoxel((linkDirection)5)->iz : -1);
